...
function(gdal_target_link_libraries target)
    ...
    is_plugin(target_is_plugin ${target})
    get_target_property(type ${target} TYPE)
    target_link_libraries(${target} PRIVATE ${_DRIVER_PRIVATE})
    if(NOT target_is_plugin AND type STREQUAL "OBJECT_LIBRARY")
        # When 'target' is an object library, CMake < 3.12
        # can only link to $<TARGET_OBJECTS:${target}>.
        # So its usage requirements must be forwarded explicitly.
